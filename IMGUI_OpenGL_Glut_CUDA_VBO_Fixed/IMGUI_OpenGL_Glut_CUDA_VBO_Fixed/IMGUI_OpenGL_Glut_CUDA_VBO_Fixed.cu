// IMGUI_OpenGL_Glut_CUDA_VBO_Fixed.cpp : Defines the entry point for the console application.
//
...
////////////////////////////////////////////////////////////////////////////////
//! IMGUI keyboard events handler
////////////////////////////////////////////////////////////////////////////////
bool keyboardEvent_IMGUI(unsigned char nChar, int nX, int nY)
{
...
////////////////////////////////////////////////////////////////////////////////
//! IMGUI mouse events handler
////////////////////////////////////////////////////////////////////////////////
bool mouseEvent_IMGUI(int button, int state, int x, int y)
{
	ImGuiIO& io = ImGui::GetIO();
...
bool motionEvent_IMGUI(int x, int y)
{
	ImGuiIO& io = ImGui::GetIO();
	io.MousePos = ImVec2((float)x, (float)y);
...
void keyboard(unsigned char key, int x, int y)
{
	if (keyboardEvent_IMGUI(key, x, y))
	{
...
void mouse(int button, int state, int x, int y)
{
	...
	if (mouseEvent_IMGUI(button, state, x, y))
	{
